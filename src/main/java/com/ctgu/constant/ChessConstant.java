...
public class ChessConstant
{
	public static final String[] DEFAULT_FONT = new String[] { "Table.font", "TableHeader.font", "CheckBox.font", "Tree.font", "Viewport.font",
			...
			"Menu.font", "OptionPane.font", "MenuBar.font", "Button.font", "Label.font", "PasswordField.font", "ScrollPane.font",
...
public static final String[] PIECES_NAME = {//
	...
	public static final int MSG_ANALYSIS_RESULT = 5;
	public static final int MSG_LOCAL_AI_MOVE     = 6; // 本地 AI 走法结果（LocalAiEngine）
	public static final int MSG_LOCAL_AI_THINKING = 7; // 本地 AI 思考过程信息

	// ── 联网功能消息类型 ──────────────────────────────────────────────
	public static final int MSG_NET_CONNECTED    = 20;  // 已连接到服务器
	public static final int MSG_NET_DISCONNECTED = 21;  // 连接断开
	public static final int MSG_NET_ERROR        = 22;  // 网络/服务器错误
	public static final int MSG_NET_REGISTER     = 23;  // 注册结果
	public static final int MSG_NET_LOGIN        = 24;  // 登录结果
	public static final int MSG_NET_ROOM_LIST    = 25;  // 房间列表
	public static final int MSG_NET_ROOM_EVENT   = 26;  // 房间相关事件（创建/加入/更新/错误）
	public static final int MSG_NET_GAME_START   = 27;  // 游戏开始
	public static final int MSG_NET_OPP_MOVE     = 28;  // 对手走法
	public static final int MSG_NET_CHAT         = 29;  // 聊天/弹幕
	public static final int MSG_NET_GAME_OVER    = 30;  // 游戏结束
	public static final int MSG_NET_PLAYER_LEFT  = 31;  // 玩家离开
